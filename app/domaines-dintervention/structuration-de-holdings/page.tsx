...
const domaine = getDomaine("structuration-de-holdings");
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/domaines-dintervention/structuration-de-holdings" }
};
...
export default function Page() {
  ...
  return (
    <main>
      <PageHero kicker={domaine.kicker} title={domaine.title} description={domaine.description} imageSrc="/images/hero/societe.jpg" />
