    ...
    <main>
      ...
      <section className="bg-ivory py-20 md:py-24">
        <div className="container-premium max-w-3xl space-y-9 text-[15px] leading-8 text-navy/78">
          ...
          <section><h2 className="font-serif text-3xl text-navy">Hébergement</h2><p>Le site est hébergé par Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, États-Unis. [À CONFIRMER lors du déploiement définitif si un autre hébergeur est retenu.]</p></section>
          ...
          <section><h2 className="font-serif text-3xl text-navy">Médiation de la consommation</h2><p>Conformément aux articles L.612-1 et suivants du Code de la consommation, le client consommateur peut recourir gratuitement au médiateur de la consommation de la profession d’avocat : Médiateur de la consommation de la profession d’avocat, 180 boulevard Haussmann, 75008 Paris, <a href="https://mediateur-consommation-avocat.fr" className="text-gold-ink underline">mediateur-consommation-avocat.fr</a>. [À VÉRIFIER selon les coordonnées ordinales en vigueur au moment de la mise en ligne.]</p></section>
        </div>
      </section>
    </main>
  );
