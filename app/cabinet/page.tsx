  ...
  return (
    <main>
      <PageHero
        ...
        imageLabel="Maître Tom Fauvel, avocat au barreau de Paris"
        imageSrc="/images/portrait-tom-fauvel.jpg"
        ...
        <div className="container-premium grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          ...
          <div>
            ...
            <div className="space-y-5 text-[17px] leading-9 text-navy/78 dark:text-ivory/72">
              <p>Le cabinet Fauvel Avocat, fondé par Maître Tom Fauvel, avocat au barreau de Paris, intervient en droit fiscal et en droit des sociétés, auprès de particuliers, de dirigeants et d’entreprises.</p>
