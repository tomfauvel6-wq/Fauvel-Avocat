...
export default function SeoPage() {
  return (
    <main>
      <PageHero kicker="Droit fiscal" title="Contentieux fiscal" description="Réclamations contentieuses, sursis de paiement, garanties et procédures devant le tribunal administratif." />
      <section className="py-20 md:py-24">
        <div className="container-premium grid gap-12 lg:grid-cols-[0.85fr_1.15fr]">
          <h1 className="font-serif text-4xl leading-tight tracking-[-0.03em] md:text-5xl">Contentieux fiscal</h1>
          <div className="space-y-6 text-[15px] leading-8 text-navy/72">
            ...
            <Link href="/domaines-dintervention/controle-fiscal" className="inline-flex bg-gold px-7 py-4 text-[12px] font-bold uppercase tracking-[0.18em] text-navy transition hover:bg-navy hover:text-white">Voir le domaine détaillé →</Link>
          </div>
        </div>
      </section>
    </main>
