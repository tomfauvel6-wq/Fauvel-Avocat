    ...
    <main>
      ...
      <section className="bg-ivory py-20 md:py-24">
        <div className="container-premium max-w-3xl space-y-9 text-[15px] leading-8 text-navy/72">
          ...
          <section><h2 className="font-serif text-3xl text-navy">Assistant d’accueil</h2><p>Le site propose un assistant conversationnel automatique, Jarvis, destiné à orienter les visiteurs. Il ne fournit aucun conseil juridique. Les messages sont traités par un prestataire d’intelligence artificielle (Anthropic) le temps de générer chaque réponse, sans conservation par ce prestataire au-delà du traitement. Lorsque le visiteur communique ses coordonnées, la conversation est transmise par courriel au cabinet afin qu’il le recontacte ; elle est alors conservée dans les mêmes conditions que toute demande de contact, couverte par le secret professionnel, et supprimée à l’issue du traitement de la demande si aucune mission n’est ouverte.</p></section><section><h2 className="font-serif text-3xl text-navy">Cookies</h2><p>Le site utilise, sous réserve de votre consentement, un cookie de mesure publicitaire déposé par Google Ads (Google Ireland Ltd), destiné à mesurer l’efficacité des annonces du cabinet (durée de conservation : 90 jours au plus). Aucun cookie publicitaire n’est déposé avant votre accord, exprimé via le bandeau affiché lors de votre première visite. Vous pouvez modifier votre choix à tout moment en supprimant les données du site dans votre navigateur, ce qui fera réapparaître le bandeau. Les cookies strictement nécessaires au fonctionnement du site ne requièrent pas de consentement.</p></section>
